...
import com.thebritishbrotherhood.rhodonite.armor.BaseArmor;
 ...
 public class rhodonitehelmet extends BaseArmor implements com.thebritishbrotherhood.rhodonite.ItemModelProvider
 {
   public rhodonitehelmet(ItemArmor.ArmorMaterial rhodonitearmor)
   {
     super(rhodonitearmor, 0, EntityEquipmentSlot.HEAD, "rhodonitehelmet");
     setUnlocalizedName("rhodonitehelmet");
     setRegistryName("rhodonitehelmet");
   }
   ...
   {
     Rhodonite.proxy.registerItemRenderer(this, 0, "rhodonitehelmet");
   }
 }
