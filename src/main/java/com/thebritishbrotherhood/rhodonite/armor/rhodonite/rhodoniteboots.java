 ...
 public class rhodoniteboots extends BaseArmor implements com.thebritishbrotherhood.rhodonite.ItemModelProvider
 {
   public rhodoniteboots(ItemArmor.ArmorMaterial rhodonitearmor)
   {
     super(rhodonitearmor, 0, EntityEquipmentSlot.FEET, "rhodoniteboots");
     setUnlocalizedName("rhodoniteboots");
     setRegistryName("rhodoniteboots");
   }

   public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced)
   {
     tooltip.add("§9Ability: §rNo Fall Damage");
   ...
   {
     Rhodonite.proxy.registerItemRenderer(this, 0, "rhodoniteboots");
   }
 }
