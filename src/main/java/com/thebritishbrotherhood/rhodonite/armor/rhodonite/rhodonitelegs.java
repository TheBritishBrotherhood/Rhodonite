...
import com.thebritishbrotherhood.rhodonite.armor.BaseArmor;
 ...
 public class rhodonitelegs extends BaseArmor implements com.thebritishbrotherhood.rhodonite.ItemModelProvider
 {
   public rhodonitelegs(ItemArmor.ArmorMaterial rhodonitearmor)
   {
     super(rhodonitearmor, 0, EntityEquipmentSlot.LEGS, "rhodonitelegs");
     setUnlocalizedName("rhodonitelegs");
     setRegistryName("rhodonitelegs");
   }
   ...
   {
     Rhodonite.proxy.registerItemRenderer(this, 0, "rhodonitelegs");
   }
 }
